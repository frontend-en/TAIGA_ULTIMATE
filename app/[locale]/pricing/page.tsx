    ...
    <>
      ...
      <PublicPageLayout title={t('title')} description={t('description')}>
        <section className="container mx-auto max-w-4xl px-4 py-12 sm:py-16">
          <ul aria-label={t('packagesLabel')} className="space-y-8" role="list">
            <li>
              <div className="rounded-2xl border border-primary-border bg-card p-6 shadow-card sm:p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h2 className="font-display text-2xl font-semibold tracking-tight">{t('packageTitle', { credits: pricing.credits })}</h2>
                    <p className="mt-2 text-3xl font-bold text-foreground">{t('packagePrice', { price: pricing.priceRub })}</p>
